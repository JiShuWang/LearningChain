...
if __name__ == '__main__':
    train_data = LoadData(data_path='../data/transaction_send_rates/ReserveSendRates_15minutes.npy', divide_days=[24, 6],
                          time_interval=15, history_length=12, train_mode='train')
    print(len(train_data))
    print(train_data[0]['park_x'].size())
    print(train_data[0]['park_y'].size())

    test_data = LoadData(data_path='../data/transaction_send_rates/ReserveSendRates_15minutes.npy', divide_days=[24, 6],
                         time_interval=15, history_length=12, train_mode='test')
    print(len(test_data))
